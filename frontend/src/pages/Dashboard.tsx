    ...
    <div className="space-y-8 animate-fadeIn">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="mt-2 text-sm text-gray-600">Welcome to KellyOS - Your complete ERP solution</p>
        </div>
      ...
      <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-4">
        {cards.map((card) => {
          ...
          return (
            <div key={card.title} className="bg-white rounded-2xl shadow-lg border border-gray-100 overflow-hidden card-hover">
              <div className="p-6">
                ...
                <div className="mt-4">
                  ...
                  <p className="text-3xl font-bold text-gray-900 mt-2">
                    {card.title === 'Total Revenue' ? formatCurrency(card.value) : card.value}
                  </p>
                </div>
              </div>
      ...
      <div className="grid grid-cols-1 gap-6 lg:grid-cols-2">
        <div className="bg-white rounded-2xl shadow-lg border border-gray-100 p-6 card-hover">
          ...
          <div className="flex flex-col items-center justify-center py-12 text-gray-400">
            ...
            <p className="text-sm">Data will appear once orders flow in.</p>
          </div>
        </div>
